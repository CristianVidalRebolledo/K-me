...
- **Postular a financiamiento público bajo un modelo ESCO** (Empresa de Servicios Energéticos). Programa ancla identificado: **"Ponle Energía a tu Pyme"** del **Ministerio de Energía + AgenciaSE** — cofinanciaba hasta 50–80% según tamaño ([ficha](https://www.agenciase.org/energia-a-tu-pyme/)). ⚠️ **Sin convocatoria vigente desde 2022** (verificado jul 2026): el subsidio se trata como acelerador, no como base de la venta. El modelo ESCO se declara en el **Registro Energético** de AgenciaSE (voluntario); gremio de referencia **ANESCO Chile**. Estado, fuentes e instrumentos alternativos en `03_SUBSIDIOS_FINANCIAMIENTO.md`.
